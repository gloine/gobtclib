 ...
 * Date: 2018/10/15 12:46
*/
func (c *Client) RescanBlockChainAsync(startHeight int64, stopHeight int64) futures.FutureResult {
	if stopHeight == 0 || stopHeight < startHeight {
		cmd := NewCommand("rescanblockchain", startHeight)
		return c.sendCmd(cmd)
	}

	cmd := NewCommand("rescanblockchain", startHeight, stopHeight)
	return c.sendCmd(cmd)
}
 ...
 * Date: 2018/10/15 17:25
*/
func (c *Client) RescanBlockChainEntire(startHeight int64, stopHeight int64) (*interface{}, error) {
